...
namespace TubeMailGorilla.Maui.Unlocked.Services
{
    ...
    public class ValidationService
    {
        ...
        /// <summary>Convenience overload kept for call-site parity (never alerts).</summary>
        public Task<ValidationVerdict> CheckOrAlertAsync(ContentPage page, string action, int requestedAmount = 0)
            => CheckAsync(action, requestedAmount);
    }
}
